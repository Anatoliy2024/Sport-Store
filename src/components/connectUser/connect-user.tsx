  ...
  return (
    <div className={style.wrapper}>
      <div className={style.block1}>
        <img src="./Rectangle%2012.png" alt="img" />
        <div className={style.container}>
          <div>
            <img src="./image 23.png" alt="img" />
          </div>
      ...
      <div className={style.block2}>
        <img src="./Rectangle%2035.png" alt="img" />
        <div className={style.container}>
          <div>
          ...
          <div className={style.wrapperInput}>
            ...
            <img src="./vect%20(1).png" alt="img" className={style.email} />
            <button>
              <img src="./vect%20(2).png" alt="img" className={style.send} />
            </button>
          </div>
          {/* <button></button> */}
        </div>
